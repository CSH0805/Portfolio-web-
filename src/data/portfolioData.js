...
// ============================================================
// 활동 포트폴리오 카드 (지그재그 섹션용)
// imageFile: src/assets/ 내 파일명
// ============================================================
export const activityPortfolio = [
  {
    ...
    tags: ['최우수상', '팀프로젝트', '1위'],
    description:
      '약쏙(앱·GPT APPS) 프로젝트로 친한 친구들과 팀을 꾸려 도전한 대회. 아이디어 회의부터 역할 분담, 개발까지 2주를 함께하며 최우수상 1위를 달성했다. 지금까지 진행한 프로젝트 중 과정 자체가 가장 즐거웠던 경험.',
    imageFile: '미래유망 고졸인력양성사업 프로젝트 챌린지.jpg',
  },
  {
    title: 'AIcraft 자율동아리 창설 및 팀장',
    date: '2024.03 – 현재',
    ...
    tags: ['동아리', '리더십', '창설'],
    description:
      '선배가 만든 자율동아리에서 배움의 가치를 체감하고 직접 AIcraft를 창설했다. 매주 화·목 21시까지 남아 자기주도학습과 팀 프로젝트를 이어가며 자연스러운 면학 분위기를 형성했다. 9월 발표회를 통해 팀원들의 발표 역량도 함께 키웠다.',
    imageFile: '미래 유망 분야 활동 사진.jpg',
  },
  {
    title: '2025년 교육급여 바우처 수기 공모전 고등부',
    date: '2025.11.13',
    category: '수상',
    tags: ['최우수상', '교육부장관상', '공모전'],
    description:
      '한국장학재단 장학금을 발판 삼아 성장해온 1년을 글로 담았다. 단순 수상 목적이 아닌 스스로의 성장을 돌아보는 의미로 도전하여 고등부 최우수상(교육부장관상)을 수상했다. 1년간 치열하게 달려온 과정이 인정받은 순간.',
    imageFile: '한국장학재단 교육부 장관상2.jpg',
  },
  {
    ...
    tags: ['특별상', '결선 진출', '8개월'],
    description:
      '4월부터 11월까지 약 8개월에 걸쳐 진행된 장기 대회. 놀봄이(노인 실종 방지 AI 앱)를 팀과 함께 기획·개발하여 결선까지 진출하고 특별상을 수상했다. 포기하지 않고 끝까지 완주한 경험이 가장 값진 성과였다.',
    imageFile: '서울직업계고창의아이디어 경진대회.jpg',
  },
  {
    ...
    tags: ['금상', '100만원', '팀리더'],
    description:
      '이전 대회에서 팀원으로 참가하던 경험을 넘어 처음으로 팀 리더로 도전했다. 팀 전체의 방향을 직접 이끌며 아이디어를 하나의 결과물로 완성해 금상을 수상했다. 기술 역량뿐 아니라 팀을 이끄는 법을 배울 수 있었던 대회.',
    imageFile: '2024 연암공과대학교 AI 해커톤.jpg',
  },
  {
    title: '2024 디지털새싹 인공지능 메이커톤',
    date: '2024.12.21 – 12.22',
    category: '수상',
    tags: ['AI어벤저스 상', '공동 1등', '협업'],
    description:
      '혼자가 아닌 팀 단위 협업 프로젝트를 처음으로 온전히 경험한 대회. Intel OpenVINO 기반 AI 프로젝트 개발로 예상치 못한 공동 1위를 달성했다. 이후 팀 프로젝트에서 협업을 주도할 수 있는 토대가 된 소중한 경험.',
    imageFile: '2024 디지털새싹 인공지능 메이커톤.jpg',
  },
  {
    ...
    tags: ['우수상', '면접', '첫 도전'],
    description:
      '1학년 말, 처음으로 마음을 다잡고 도전한 외부 대회. 결과는 우수상(4등)이었지만, 대회에 대한 두려움을 극복하는 전환점이 되었다. 이후 AI 해커톤·프로젝트 챌린지 등 다수 대회에 도전할 수 있었던 원동력이 된 경험.',
    imageFile: '2024 TBI 면접경진대회.jpg',
  },
  {
    title: 'AI융합수업 — 환경 AI 프로젝트 (Clean Earth)',
    date: '2025 (2학년)',
    category: '교내활동',
    tags: ['2학년 전체 1등', '팀프로젝트', 'AI'],
    description:
      '환경오염 문제를 AI로 해결하는 수업. 팀에서 YOLOv11 기반 쓰레기 분류 AI를 개발해 리폼 물품을 추천하는 앱(Clean Earth)을 제작했다. 4팀 중 선발되어 전체 발표를 진행하고 2학년 전체 1등을 달성했다.',
    imageFile: 'AI융합수업.jpg',
  },
  {
    ...
    description:
      '대한상공회의소 주관 학과 선발 20명 대상 실무 교육. PBL기반 Java 객체지향 설계, React 프론트엔드, AI기반 빅데이터 분석, AWS 환경 AI 실무, SMART 앱 프로그래밍 등 총 6개 과정을 수료하며 실전 개발 역량을 쌓았다.',
    imageFile: '미래유망 수료증.jpg',
  },
  {
    title: 'IBM 본사 견학',
    date: '2025.03.28',
    category: '견학',
    tags: ['기업 견학', 'AI 산업', '친환경'],
    description:
      '고등학교 2학년 때 IBM 본사 견학에 참여해 AI 기술의 현재와 미래를 학습했다. 태양열 에너지로 배터리를 충전해 24시간 바다를 항해하며 데이터를 수집하는 무인 선박 기술이 가장 인상적이었다. 기술 발전의 속도를 피부로 체감한 시간.',
    imageFile: 'IBM견학.jpg',
  },
  {
    title: '2025 AI 동고동락 교내 대회',
    date: '2025.12.04',
    category: '교내활동',
    tags: ['동상', '3위', 'AI 프로젝트'],
    description:
      '교내 AI 프로젝트 경연 대회인 AI 동고동락에 참가하여 동상(3위)을 수상했다. 개인 역량을 AI 프로젝트로 구현하고 발표하는 자리로, 평소 쌓아온 AI 개발 경험을 교내에서 검증할 수 있었던 기회였다.',
    imageFile: '2025AI동고동락(동상 3위).jpg',
  },
  {
    title: '교내 선행상',
    date: '2025.01.10',
    ...
    tags: ['선행상', '품행', '모범'],
    description:
      '품행이 바르고 성실하며 매사에 솔선수범하여 다른 학생의 모범이 된다는 이유로 세명컴퓨터고등학교장으로부터 선행상을 수여받았다. 기술 역량뿐 아니라 인성 면에서도 인정받은 상으로 개인적으로 뜻깊은 수상이다.',
    imageFile: '2025선행상.jpg',
  },
  {
    ...
    tags: ['학급회장', '리더십', '1학년'],
    description:
      '1학년 2학기 학급회장으로 선출되어 학급을 이끌었다. 학생회 활동을 통해 책임감과 리더십을 기를 수 있었으며, 이후 AIcraft 동아리 창설 및 팀장 역할을 맡는 데 밑거름이 되었다.',
    imageFile: '2024 2학기 학급회장.jpg',
  },
];
